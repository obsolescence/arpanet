...
const arpanetNodes = [
  ...
  { name: 'SRI - PDP-15', name1: 'SRI', name2: 'PDP-15', x: 98, y: 150, rx: 30, ry: 15, 		host: 66, 	hostname: 'SRI-AI', system: '?', status: '?' },
  { name: 'SRI - IMP', name1: 'SRI', name2: 'IMP', x: 177, y: 150, rx: 18, ry: 13,		host: 2, lat: 37.4564811, lon: -122.1753924 },
  ...
  { name: 'XEROX - 316 IMP', name1: 'XEROX', name2: '316 IMP', x: 238, y: 227, rx: 25, ry: 13, host: 32},

  { name: 'AMES - 360/67', name1: 'AMES', name2: '360/67', x: 98, y: 303, rx: 33, ry: 15, host: 16, 	hostname: 'AMES-67', computer: 'IBM 360/67', status: 'Server' },
  { name: 'AMES - TIP', name1: 'AMES', name2: 'TIP', x: 182, y: 303, rx: 18, ry: 13, host: 144, 	hostname: 'AMES-TIP', computer: 'TIP', status: 'TIP' },
  { name: 'AMES - IMP', name1: 'AMES', name2: 'IMP', x: 182, y: 506, rx: 18, ry: 13,		host: 16 },
  { name: 'AMES - PDP-10', name1: 'AMES', name2: 'PDP-10', x: 255, y: 507, rx: 18, ry: 13, host: 999, hostname: '?', computer: '?', status: '?' },

  { name: 'HAWAII - TIP', name1: 'HAWAII', name2: 'TIP', x: 59, y: 506, rx: 22, ry: 12, 		host: 164, 	hostname: 'ALOHA-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'FNWC - TIP', name1: 'FNWC', name2: 'TIP', x: 262, y: 378, rx: 22, ry: 12, 		host: 161, 	hostname: 'FNWC-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'LBL - 316 IMP', name1: 'LBL', name2: '316 IMP', x: 451, y: 150, rx: 25, ry: 13, 	host: 34, lat: 37.8769588, lon: -122.2456303 },
  ...
  { name: 'UTAH - IMP', name1: 'UTAH', name2: 'IMP', x: 583, y: 150, rx: 18, ry: 13, 		host: 4, lat: 40.7628137, lon: -111.8368719 },
  ...
  { name: 'ILLINOIS - IMP', name1: 'ILLINOIS', name2: 'IMP', x: 713, y: 150, rx: 18, ry: 13, lat: 40.1131564, lon: -88.2247919 },
  ...
  { name: 'MIT - IMP', name1: 'MIT', name2: 'IMP', x: 1010, y: 150, rx: 18, ry: 13, 		host: 6, lat: 42.3582529, lon: -71.0966272 },
  ...
  { name: 'LINCOLN - IMP', name1: 'LINCOLN', name2: 'IMP', x: 866, y: 243, rx: 22, ry: 12,	host: 10, lat: 42.4571974, lon: -71.2668016 },

  { name: 'CCA - TIP', name1: 'CCA', name2: 'TIP', x: 1009, y: 219, rx: 25, ry: 12, 		host: 159, hostname: 'CCA-TIP', computer: 'TIP', status: 'TIP' },
  ...
  { name: 'BBN - TIP', name1: 'BBN', name2: 'TIP', x: 942, y: 340, rx: 22, ry: 12, 		host: 158, hostname: 'BBN-TESTIP', computer: 'TIP', status: 'TIP'},
  ...
  { name: 'BBN - PDP-1', name1: 'BBN', name2: 'PDP-1', x: 1095, y: 309, rx: 30, ry: 15, 	host: 232, hostname: 'BBN-1D', computer: 'PDP-1', system: 'PDP-1 TS', status: 'User' },
  { name: 'BBN - H316', name1: 'BBN', name2: 'H316', x: 1095, y: 374, rx: 28, ry: 15, 		host: 40, hostname: 'BBN-NCC', computer: 'H-316', system: 'H-316', status: 'User' },
  ...
  { name: 'BBN - IMP', name1: 'BBN', name2: 'IMP', x: 1016, y: 340, rx: 18, ry: 13,		host: 5, lat: 42.3908323, lon: -71.1469589 },

  { name: 'HARVARD - PDP-11', name1: 'HARVARD', name2: 'PDP-11', x: 930, y: 493, rx: 35, ry: 15, host: 137, hostname: 'HARV-11', computer: 'PDP-11', status: 'User' },
  ...
  { name: 'ABERDEEN - 316 IMP', name1: 'ABERDEEN', name2: '316 IMP', x: 1014, y: 565, rx: 25, ry: 13,	host: 995 },

  { name: 'NBS - TIP', name1: 'NBS', name2: 'TIP', x: 1014, y: 631, rx: 18, ry: 13, 		host: 147, hostname: 'NBS-TIP', computer: 'TIP', status: 'TIP' },
  ...
  { name: 'ETAC - TIP', name1: 'ETAC', name2: 'TIP', x: 1014, y: 825, rx: 22, ry: 12, 		host: 148, hostname: 'ETAC-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'ARPA - TIP', name1: 'ARPA', name2: 'TIP', x: 981, y: 757, rx: 22, ry: 12, 		host: 156, hostname: 'ARPA-TIP', computer: 'TIP', status: 'TIP' },
  { name: 'ARPA - PDP-15', name1: 'ARPA', name2: 'PDP-15', x: 898, y: 757, rx: 30, ry: 15, 	host: 28, hostname: 'ARPA-DMS', computer: 'PDP-15', status: 'User' },

  { name: 'SDAC - TIP', name1: 'SDAC', name2: 'TIP', x: 920, y: 628, rx: 22, ry: 12, 		host: 154, hostname: 'SDAC-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'BELVOIR - 316 IMP', name1: 'BELVOIR', name2: '316 IMP', x: 879, y: 563, rx: 25, ry: 13, host: 27 },
  ...
  { name: 'CARNEGIE - IMP', name1: 'CARNEGIE', name2: 'IMP', x: 811, y: 458, rx: 22, ry: 12,		host: 14, lat: 40.4441897, lon: -79.9427192 },

  { name: 'CASE - IMP', name1: 'CASE', name2: 'IMP', x: 736, y: 344, rx: 22, ry: 12,		host: 13, lat: 41.501387, lon: -81.6007022 },
  ...
  { name: 'RADC - TIP', name1: 'RADC', name2: 'TIP', x: 792, y: 312, rx: 22, ry: 12, 		host: 146, hostname: 'RADC-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'GWC - TIP', name1: 'GWC', name2: 'TIP', x: 675, y: 402, rx: 22, ry: 12, 		host: 152, hostname: 'GWC-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'DOCB - TIP', name1: 'DOCB', name2: 'TIP', x: 622, y: 451, rx: 22, ry: 12, 		host: 153, hostname: 'DOCB-TIP', computer: 'TIP', status: 'TIP' },

  { name: 'USC - 360/44', name1: 'USC', name2: '360/44', x: 633, y: 505, rx: 35, ry: 15, 	host: 23, hostname: 'USC-44', computer: 'IBM 360/44', status: 'Server' },
  { name: 'USC - TIP', name1: 'USC', name2: 'TIP', x: 551, y: 500, rx: 35, ry: 15, 		host: 151, hostname: 'USC-TIP', computer: 'TIP', status: 'TIP' },
  ...
  { name: 'SDC - IMP', name1: 'SDC', name2: 'IMP', x: 496, y: 553, rx: 40, ry: 15,		host: 8 },
  { name: 'SDC - DDP-516', name1: 'SDC', name2: 'DDP-516', x: 588, y: 553, rx: 40, ry: 15,  	host: 999, hostname: '?', computer: 'DDP-516', status: '?' },
  ...
  { name: 'UCLA - IMP', name1: 'UCLA', name2: 'IMP', x: 378, y: 643, rx: 22, ry: 12,		host: 1,  lat: 34.0708777, lon: -118.4468503 },
  ...
  { name: 'UCSD - 316 IMP', name1: 'UCSD', name2: '316 IMP', x: 323, y: 694, rx: 25, ry: 13 },
  { name: 'UCSD - MICRO/810', name1: 'UCSD', name2: 'MICRO/810', x: 408, y: 690, rx: 35, ry: 15, host: 35, hostname: 'UCSD-CC', computer: 'Micro 810 / B6700', status: 'Server' },
  { name: 'UCSD - B6700', name1: 'UCSD', name2: 'B6700', x: 409, y: 732, rx: 32, ry: 15, 	host: 35, hostname: 'UCSD-CC', computer: 'B6700', status: 'Server' },

  { name: 'RAND - IBM 1800', name1: 'RAND', name2: 'IBM 1800', x: 321, y: 755, rx: 30, ry: 13,	host: 999, hostname: '?', computer: 'IBM 1800', status: '?' },
  { name: 'RAND - 316 IMP', name1: 'RAND', name2: '316 IMP', x: 255, y: 748, rx: 25, ry: 13,	host: 7, lat: 34.0095671, lon: -118.4907088 },
  ...
  { name: 'USC-ISI - IMP', name1: 'USC-ISI', name2: 'IMP', x: 174, y: 827, rx: 18, ry: 13,	host: 22 },
  ...
  { name: 'UCSB - IMP', name1: 'UCSB', name2: 'IMP', x: 342, y: 570, rx: 22, ry: 12,		host: 3, lat: 34.4146025, lon: -119.84581 },
  ...
  { name: 'STANFORD - IMP', name1: 'STANFORD', name2: 'IMP', x: 181, y: 621, rx: 18, ry: 13,	host: 11, lat: 37.4351796, lon: -122.1746129 },

  { name: 'MITRE - TIP', name1: 'MITRE', name2: 'TIP', x: 949, y: 692, rx: 22, ry: 12, host: 145, hostname: 'MITRE-TIP', computer: 'TIP', status: 'TIP', lat: 42.5052939, lon: -71.2370477 },

  { name: 'RML - TIP', name1: 'RML', name2: 'TIP', x: 787, y: 825, rx: 22, ry: 12, host: 165, hostname: 'RML-TIP', computer: 'TIP', status: 'TIP' },
];
