...
def generate_imp_config(imp_node, nodes_data, node_names, hosts_by_location, output_dir='..'):
    """
    ...
    if imp_name in hosts_by_location:
        ...
        for host_index, hostname, front in host_list:
            ...
            if host_index < 2 and front != 1:
                ...
                if host_index == 1:
                    config_lines.append("set hi2 convert")
                config_lines.append("")
            else:
...
def generate_start_script(nodes_data, node_names, hosts_by_location, output_dir='..'):
    """
...
def main():
    ...
    if choice == '1':
        ...
        control_script = generate_start_script(nodes, node_names, hosts_by_location, config_output_dir)
        ...
        generated_files = []
        for node in nodes:
            output_file = generate_imp_config(node, nodes, node_names, hosts_by_location, config_output_dir)
